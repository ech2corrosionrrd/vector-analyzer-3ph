...
import { X, Info, Smartphone, Monitor, CheckCircle2, Zap } from 'lucide-react';
      ...
      <div className="relative bg-slate-900 border border-slate-700/50 w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden animate-zoom-in">
        ...
        <div className="p-6 md:p-8 overflow-y-auto max-h-[70vh] custom-scrollbar space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-blue-600/10 p-4 rounded-2xl border border-blue-500/20 flex items-start gap-4">
              <Monitor className="text-blue-400 shrink-0 mt-1" size={20} />
              <div>
                <h4 className="text-white text-sm font-bold mb-1">На комп'ютері (PC/Mac)</h4>
                <p className="text-slate-400 text-xs">
                  Натисніть іконку встановлення (квадрат зі стрілкою) безпосередньо в адресному рядку зверху.
                </p>
              </div>
            </div>
          </section>
        ...
        <div className="p-6 bg-slate-950/50 border-t border-slate-800 text-center">
          <p className="text-slate-500 text-xs">VectorAnalyzer 3Ph v1.3.0 • 2026.03</p>
